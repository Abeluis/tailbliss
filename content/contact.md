...
draft: false
language: es
description: ¿Tienes algun comentario, duda, sugerencia, pregunta?
---
...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">¿Tienes algún comentario, duda, sugerencia, pregunta, oferta laboral?
      Contactame</p>
